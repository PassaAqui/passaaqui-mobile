...
import PostcardFront from "@/src/features/roles/user/map/postcard/components/PostcardFront";
import PostcardBack from "@/src/features/roles/user/map/postcard/components/PostcardBack";
