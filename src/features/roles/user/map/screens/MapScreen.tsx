...
import OutsideRegionModal from "@/src/features/roles/user/map/components/OutsideRegionModal";
import TouristSpotPOI from "@/src/features/roles/user/map/poi/components/TouristSpotPOI";
import ShopkeeperPOI from "@/src/features/roles/user/map/poi/components/ShopkeeperPOI";
import StopButton from "@/src/features/roles/user/map/components/StopButton";
import FollowUserButton from "@/src/features/roles/user/map/components/FollowUserButton";
import SwitchDestinationModal from "@/src/features/roles/user/map/components/SwitchDestinationModal";
import StopConfirmation from "@/src/features/roles/user/map/poi/components/StopConfirmation";
import { useMapScreen } from "@/src/features/roles/user/map/hooks/useMapScreen";
import { SafeAreaView } from "react-native-safe-area-context";
import { useSafeAreaInsets } from "react-native-safe-area-context";
import GpsDisabledModal from "@/src/features/roles/user/map/components/GpsDisabledModal";
import AnimatedPostcardModal from "@/src/features/roles/user/map/postcard/components/AnimatedPostcardModal";
import CheckinRewardModal from "@/src/features/roles/user/map/poi/components/CheckinRewardModal";
