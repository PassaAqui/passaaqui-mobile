...
import WithoutSticker from "@/src/features/roles/user/achievements/components/WithoutSticker";
import CompleteSticker from "@/src/features/roles/user/achievements/components/CompleteSticker";
