      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: insets.bottom + 16 }} showsVerticalScrollIndicator={false}>
        <View className="items-center justify-center p-6 gap-6">
          <View className="flex-col items-center justify-center gap-3">
            <View className="bg-green-200 p-5 rounded-full border-2 border-green-500 items-center justify-center">
          ...
          <View className="w-full items-center justify-center gap-5">
            <View className="w-full border border-gray-400 flex-col rounded-2xl px-4 py-4">
              ...
              <View className="w-full flex-row items-center py-3 gap-3">
                ...
                <Text className="font-interBold text-lg">R$ PREÇO</Text>
              </View>
              ...
              <View className="flex-row justify-between">
                ...
                <Text className="font-inter" adjustsFontSizeToFit>R$ PREÇO</Text>
              </View>
              ...
              <View className="flex-row justify-between">
                ...
                <Text className="font-interBold text-green-600" adjustsFontSizeToFit>- R$ PREÇO</Text>
              </View>
              ...
              <View className="flex-row justify-between items-center">
                ...
                <Text className="font-interBold text-xl">R$ PREÇO</Text>
              </View>
            </View>
